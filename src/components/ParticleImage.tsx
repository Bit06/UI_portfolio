...
function getTransitionParams(tr: any) {
    ...
    return {
        easeFn: (EASE as any)[tr.ease] || EASE.easeOut,
...
export default function ParticleImage(__props: any) {
    ...
    const sceneRef = useRef<{particles: any[]}>({ particles: [] })
    ...
    useEffect(() => {
        ...
        image, mode, sizeUnit, widthPx, heightPx, widthPct, heightPct, scale, particleCount, hover, hoverType, roamWidth, roamHeight, roamShape, hideType,
    ])
